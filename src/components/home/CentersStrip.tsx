        ...
        <div className="mb-10 flex flex-wrap items-end justify-between gap-4">
          <div>
            <div className="mb-3 inline-flex items-center gap-2 rounded-full bg-white/15 px-3 py-1 text-xs font-semibold">
              ...
              {isAr ? "مراكز التميّز" : "Centers of Excellence"}
            </div>
            <h2 className="text-3xl md:text-4xl font-bold">
              {isAr ? "رعاية متخصصة عالية الجودة" : "Specialized care, world-class quality"}
            </h2>
            <p className="mt-2 max-w-2xl text-white/80">
              {isAr
                ? "مراكز متكاملة يقودها استشاريون في تخصصات دقيقة، بتقنيات حديثة وبروتوكولات معتمدة."
                : "Integrated centers led by senior consultants, with modern technology and certified protocols."}
            </p>
          </div>
          <Link
            to="/excellence"
              ...
              <div className="relative aspect-[4/3] overflow-hidden bg-navy-deep/50">
                {c.hero_image_url ? (
                  ...
                  <div className="h-full w-full grid place-items-center text-6xl text-white/20 font-bold">
                    {(isAr ? c.name_ar : c.name_en).charAt(0)}
                  </div>
                )}
